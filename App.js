// GeoCheckr v5 — react-native-maps Street View
import React, { useState, useRef, useEffect, useCallback } from 'react';
import {
  View, Text, TouchableOpacity, StyleSheet, Animated,
  Vibration, StatusBar, Dimensions, TextInput, Platform
} from 'react-native';
    ...
    return (
      <View style={s.container}>
        ...
        <MapView
          ...
          showsTraffic={false}
        >
          <Marker coordinate={{latitude:currentLoc.lat, longitude:currentLoc.lng}} />
        </MapView>
...
const s = StyleSheet.create({
  ...
  homeTitle:{fontSize:42,fontWeight:'900',color:C.onSurface,letterSpacing:-1,fontFamily:'Space Grotesk'},
  homeSub:{fontSize:18,color:C.onSurfaceVariant,marginTop:4,marginBottom:32,fontFamily:'Inter'},
  modeRow:{width:'100%',gap:12},
  modeBtn:{backgroundColor:C.surfaceContainerLowest,borderRadius:24,padding:20,alignItems:'center',borderWidth:1,borderColor:C.outline,paddingVertical:28},
  modeBtnIcon:{fontSize:36,marginBottom:8},
  modeBtnLabel:{fontSize:20,fontWeight:'800',color:C.onSurface,fontFamily:'Space Grotesk'},
  modeBtnSub:{fontSize:13,color:C.onSurfaceVariant,marginTop:4,fontFamily:'Inter'},
  ...
  timerText:{color:C.onSurface,fontSize:18,fontFamily:'Space Grotesk',fontWeight:'700'},
  ...
  roundText:{color:C.onSurfaceVariant,fontSize:14,fontFamily:'Inter'},
  ...
  actionBtnText:{color:C.onPrimary,fontSize:16,fontWeight:'800',fontFamily:'Space Grotesk'},
  inputWrap:{flex:1,justifyContent:'center',padding:24,zIndex:1},
  inputTitle:{fontSize:36,fontWeight:'900',color:C.onSurface,textAlign:'center',marginBottom:4,fontFamily:'Space Grotesk'},
  inputHint:{fontSize:14,color:C.onSurfaceVariant,textAlign:'center',marginBottom:24,fontFamily:'Inter'},
  textInput:{backgroundColor:C.surfaceContainerLowest,borderRadius:16,padding:16,fontSize:18,color:C.onSurface,borderWidth:1,borderColor:C.outline,marginBottom:16,fontFamily:'Inter'},
  submitBtn:{backgroundColor:C.primary,borderRadius:16,padding:16,alignItems:'center'},
  submitBtnText:{color:C.onPrimary,fontSize:16,fontWeight:'800',fontFamily:'Space Grotesk'},
  resultContent:{flex:1,justifyContent:'center',alignItems:'center',padding:32},
  resultEmoji:{fontSize:80,marginBottom:16},
  resultTitle:{fontSize:36,fontWeight:'900',color:C.onSurface,textAlign:'center',marginBottom:4,fontFamily:'Space Grotesk'},
  resultCity:{fontSize:18,color:C.onSurfaceVariant,textAlign:'center',marginBottom:8,fontFamily:'Inter'},
  resultPts:{fontSize:24,color:'#4ade80',fontWeight:'700',marginBottom:16,fontFamily:'Space Grotesk'},
  resultTotal:{fontSize:16,color:C.onSurfaceVariant,marginBottom:32,fontFamily:'Inter'},
  nextBtn:{backgroundColor:C.primary,borderRadius:16,padding:16,paddingHorizontal:32,alignItems:'center'},
  nextBtnText:{color:C.onPrimary,fontSize:16,fontWeight:'800',fontFamily:'Space Grotesk'},
  summaryContent:{flex:1,justifyContent:'center',alignItems:'center',padding:24},
  summaryEmoji:{fontSize:64,marginBottom:12},
  summaryTitle:{fontSize:28,fontWeight:'900',color:C.onSurface,marginBottom:4,fontFamily:'Space Grotesk'},
  summaryScore:{fontSize:48,fontWeight:'900',color:C.primary,marginBottom:4,fontFamily:'Space Grotesk'},
  summarySub:{fontSize:16,color:C.onSurfaceVariant,marginBottom:24,fontFamily:'Inter'},
  ...
  historyCity:{color:C.onSurface,fontSize:14,fontFamily:'Inter'},
  historyStatus:{fontSize:14,fontWeight:'700',fontFamily:'Space Grotesk'},
  restartBtn:{backgroundColor:C.primary,borderRadius:16,padding:16,paddingHorizontal:32,alignItems:'center'},
  restartBtnText:{color:C.onPrimary,fontSize:16,fontWeight:'800',fontFamily:'Space Grotesk'},
});
