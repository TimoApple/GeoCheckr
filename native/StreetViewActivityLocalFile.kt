...
// Approach: WebView loads HTML from assets (same as working test-standalone.html)
class StreetViewActivityLocalFile : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        Log.d("GeoCheckr", "LocalFile Activity: lat=$lat, lng=$lng")
...
<script src="https://maps.googleapis.com/maps/api/js?key=$apiKey&callback=initMap" async defer></script>
        ...
        // Load from data URL (same as loadDataWithBaseURL but with proper base)
