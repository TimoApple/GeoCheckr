...
const styles = StyleSheet.create({
  ...
  scanArea: { width: 250, height: 250, borderWidth: 2, borderColor: '#ff3333', borderRadius: 10, justifyContent: 'center', alignItems: 'center' },
  scanText: { color: '#fff', fontSize: 14, textAlign: 'center', backgroundColor: 'rgba(0,0,0,0.7)', padding: 10, borderRadius: 5 },
  button: { backgroundColor: '#ff3333', padding: 15, borderRadius: 10, marginTop: 10 },
