...
const styles = StyleSheet.create({
  ...
  // Header
  header: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', padding: 15, backgroundColor: '#12121f', borderBottomWidth: 1, borderBottomColor: '#1e1e30' },
  headerLeft: { flex: 1 },
  playerName: { color: '#ff3333', fontSize: 18, fontWeight: 'bold' },
  playerTurn: { color: '#8888aa', fontSize: 12 },
  ...
  // Scoreboard
  scoreboard: { flexDirection: 'row', justifyContent: 'space-around', paddingVertical: 14, paddingHorizontal: 16, backgroundColor: '#0f0f1a', borderBottomWidth: 1, borderBottomColor: '#1e1e30' },
  scoreItem: { alignItems: 'center', padding: 10, minWidth: 90, borderRadius: 8 },
  activeScore: { borderBottomWidth: 3, borderBottomColor: '#ff3333', backgroundColor: 'rgba(255, 51, 51, 0.1)' },
  scoreName: { color: '#8888aa', fontSize: 13, marginBottom: 4, textAlign: 'center' },
  ...
  phaseText: { fontSize: 16, color: '#8888aa', marginBottom: 25, textAlign: 'center', lineHeight: 22 },
  scanButton: { backgroundColor: '#ff3333', paddingVertical: 18, paddingHorizontal: 40, borderRadius: 14 },
  scanButtonText: { color: '#fff', fontSize: 20, fontWeight: 'bold' },
  scanHint: { color: '#555577', fontSize: 12, marginTop: 15 },
  ...
  countdownOverlay: { position: 'absolute', top: 10, right: 10, backgroundColor: 'rgba(0,0,0,0.85)', borderRadius: 24, width: 48, height: 48, justifyContent: 'center', alignItems: 'center', borderWidth: 2, borderColor: '#ff3333', zIndex: 10 },
  ...
  answerPhaseContainer: { position: 'absolute', top: 0, left: 0, right: 0, bottom: 0, backgroundColor: '#0a0a14', zIndex: 10, alignItems: 'center', justifyContent: 'center', padding: 20 },
  ...
  skipAnswerText: { color: '#555577', fontSize: 14, textDecorationLine: 'underline' },
  ...
  resultRow: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', paddingVertical: 12, borderBottomWidth: 1, borderBottomColor: '#1e1e30' },
  resultLabel: { color: '#8888aa', fontSize: 16, flexShrink: 0 },
  ...
  nextButton: { backgroundColor: '#12121f', paddingVertical: 16, paddingHorizontal: 30, borderRadius: 14, borderWidth: 1, borderColor: '#ff3333', marginBottom: 10 },
  nextButtonText: { color: '#ff3333', fontSize: 18, fontWeight: '600' },
  ...
  summarySubtitle: { fontSize: 16, color: '#8888aa', marginBottom: 25, textAlign: 'center' },
  leaderboardItem: { flexDirection: 'row', alignItems: 'center', backgroundColor: '#12121f', borderRadius: 12, padding: 15, marginBottom: 10, width: '100%', borderWidth: 1, borderColor: '#1e1e30' },
  leaderboardFirst: { borderColor: '#FFD700', borderWidth: 2, backgroundColor: 'rgba(255, 215, 0, 0.08)' },
  ...
  historyRow: { flexDirection: 'row', alignItems: 'center', paddingVertical: 8, borderBottomWidth: 1, borderBottomColor: '#1e1e30', width: '100%' },
  historyRound: { color: '#555577', fontSize: 12, width: 30 },
  historyPlayer: { color: '#fff', fontSize: 13, flex: 1 },
  historyLocation: { color: '#8888aa', fontSize: 13, flex: 1 },
  historyPoints: { color: '#4CAF50', fontSize: 14, fontWeight: 'bold', width: 40, textAlign: 'right' },
  restartButton: { backgroundColor: '#ff3333', paddingVertical: 16, paddingHorizontal: 30, borderRadius: 14, marginTop: 25, width: '100%', alignItems: 'center' },
  restartButtonText: { color: '#fff', fontSize: 18, fontWeight: 'bold' },
  homeButton: { backgroundColor: '#12121f', paddingVertical: 14, paddingHorizontal: 25, borderRadius: 14, marginTop: 12, width: '100%', alignItems: 'center', borderWidth: 1, borderColor: '#1e1e30' },
  homeButtonText: { color: '#8888aa', fontSize: 16 },
});
